...
function ChangePassForm({ session, users, onChangePass }) {
  ...
  return React.createElement("div", { style: { background: "#0d1117", border: "1px solid #1e2636", borderRadius: 14, padding: "18px 16px" } },
    React.createElement(PassInput, { label: "Senha atual", value: oldPass, onChange: setOldPass, show: showOld, setShow: setShowOld }),
    React.createElement(PassInput, { label: "Nova senha", value: newPass, onChange: setNewPass, show: showNew, setShow: setShowNew }),
    React.createElement(PassInput, { label: "Confirmar nova", value: confirm, onChange: setConfirm, show: showNew, setShow: setShowNew }),
