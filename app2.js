...
function ChangePassForm({ session, users, onSave, msg, setMsg }) {
  ...
  function handleSave() {
    ...
    if (newPass.length < 4) { setMsg({ type: "err", text: "Mínimo 4 caracteres." }); return; }
    if (newPass !== confirm) { setMsg({ type: "err", text: "Senhas não coincidem." }); return; }
    onSave(newPass);
  }

  return /* @__PURE__ */ React.createElement("div", { style: { background: "#0d1117", border: "1px solid #1e2636", borderRadius: 14, padding: "18px 16px" } },
    /* @__PURE__ */ React.createElement(PassInput, { label: "Senha atual", value: oldPass, onChange: setOldPass, show: showOld, setShow: setShowOld }),
    /* @__PURE__ */ React.createElement(PassInput, { label: "Nova senha", value: newPass, onChange: setNewPass, show: showNew, setShow: setShowNew }),
    /* @__PURE__ */ React.createElement(PassInput, { label: "Confirmar nova", value: confirm, onChange: setConfirm, show: showNew, setShow: setShowNew }),
    msg && /* @__PURE__ */ React.createElement("div", { style: { background: msg.type === "ok" ? "#00e5a018" : "#ff4d6d12", border: "1px solid " + (msg.type === "ok" ? "#00e5a044" : "#ff4d6d44"), borderRadius: 8, padding: "9px 12px", fontSize: 12, color: msg.type === "ok" ? "#00e5a0" : "#ff8099", marginBottom: 14, textAlign: "center" } }, msg.type === "ok" ? "\u2713 " : "", msg.text),
    /* @__PURE__ */ React.createElement("button", { onClick: handleSave, style: { width: "100%", background: "linear-gradient(135deg,#1a3a6a,#2a5aaa)", border: "1px solid #4a8aff44", color: "#e0f0ff", borderRadius: 10, padding: "12px 0", cursor: "pointer", fontSize: 14, fontWeight: 700, fontFamily: "monospace" } }, "Salvar nova senha")
  );
}
