...
function ProductionCalcModal({ onClose }) {
  ...
  const [ciclo, setCiclo] = useState("22");
  const [pecasCiclo, setPecasCiclo] = useState("1");
  const [pecasCaixa, setPecasCaixa] = useState("50");
  const [caixasFardo, setCaixasFardo] = useState("10");
